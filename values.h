...
class Values {
  public:
    ...
    [[nodiscard]] QString FromMail() const { return fromMail; }
    ...
    [[nodiscard]] QString ToMail() const { return toMail; }

    /// @brief Returns true if the download path is configured.
    [[nodiscard]] bool filledValues() const { return !ruta.isEmpty(); }
    ...
    [[nodiscard]] QString Fecha() const { return fecha; }
    ...
    [[nodiscard]] bool Debug() const { return debug; }
    ...
    [[nodiscard]] QString SmtpServer() const { return smtpServer; }
    ...
    [[nodiscard]] QString SmtpLogin() const { return smtpLogin; }
    ...
    [[nodiscard]] QString SmtpPass() const { return smtpPass; }
